...
export default function Hero({ hero }: Readonly<HeroProps>) {
  ...
  useEffect(() => {
    ...
    // Use requestIdleCallback to defer non-critical search suggestions
  ...
  // Fetch backend suggestions - optimized with startTransition to reduce TBT
  const fetchSuggestions = async () => {
    try {
      ...
      // Use async rankSkills to break up the work
      const processSuggestions = async () => {
        // Rank skills asynchronously to avoid blocking
        ...
        const mergedPopular = Array.from(new Set([...backendPopular, ...rankedIndustry])).slice(
          0,
          15
        );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">{hero?.hero_heading ? parse(hero.hero_heading) : null}</div>
            ...
            <div className="pt-4">
              ...
              <style jsx>{`
                ...
                /* Animation moved to external CSS file (animations.css) for better performance */
              `}</style>
            </div>
          </div>
